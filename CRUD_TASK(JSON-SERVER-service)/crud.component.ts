...
export class CrudComponent implements OnInit {
  ...
  addEmps_click()
  {
    ...
    this.empService.addData(empObj).subscribe( (response:any) =>{
  ...
  {
    this.empService.deleteData(empno).subscribe( (response:any) =>{
  ...
  {
    this.empService.getDataById(empno).subscribe( (response:any) =>{
  ...
  updateEmps_click()
  {
    ...
    this.empService.updateData(empObj).subscribe( (response:any) =>{
